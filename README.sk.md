...
> **Toto je slovenský preklad README** pre [tento neoficiálny fork](https://github.com/rraddatch/CCAe) nástroja [Colour Contrast Analyser od TPGi](https://github.com/ThePacielloGroup/CCAe). Pôvodné anglické README nájdeš v [README.md](README.md).
